import { addAddressToDatabase, address } from "../../services/AddressService";
...
export default function UpdateAddress({
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await address(id, addressData); 
      ...
      setErrorMessage(
        ...
        "Error creating address. Please try again later."
      );
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 shadow rounded-lg">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Add Address</h1>
